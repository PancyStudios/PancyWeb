...
export default function MusicPage() {
    ...
    const [isPlaying, setIsPlaying] = useState(false); // Visual state for now
                    ...
                    <div className="glass-panel p-8 rounded-3xl border border-white/5 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div className="flex-1 w-full text-center md:text-left">
                                <div className="mb-2">
                                    <span className="text-xs font-bold text-pink-400 tracking-wider uppercase">Reproduciendo ahora</span>
                                    <h3 className="text-2xl font-bold text-white truncate">Nothing Playing</h3>
                                    <p className="text-slate-400 text-sm">Unirse a un canal de voz para comenzar</p>
                                </div>

                                {/* Progress Bar */}
                                <div className="w-full h-1.5 bg-white/10 rounded-full mt-6 mb-6 overflow-hidden">
                                    <div className="h-full w-1/3 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full relative">
                                ...
                                <div className="flex items-center justify-center md:justify-start gap-6">
                                    <button className="p-3 rounded-xl hover:bg-white/10 text-slate-300 hover:text-white transition-colors">
